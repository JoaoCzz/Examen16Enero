package com.corenetworks.EjercicioRobot;
...
public class ClienteRobot {
    public static void main(String[] args) {
        ...
        private static String mostrarMenu() {
            String[] preguntas = {"Horio de la tienda?", "Que dias no abren?", "¿Tienes libros de Java desde cero", "Precio del libro"};
            int numPregunta=0;
            ...
            //
            while (true){
                System.out.println("Opcion seleccionadon ->");
